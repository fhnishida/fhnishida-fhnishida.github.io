...
# # testando Max LogLik do exemplo - NÃO APARECE
# loglik = function(theta) {
#   b0hat = theta[1]
#   b1hat = theta[2]
#   y = as.matrix(mtcars$am)
#   X = as.matrix(cbind(1, mtcars$cyl))
#   bhat = matrix(c(b0,b1), ncol=1)
#   
#   yhat = X %*% bhat
#   prob = ifelse(y==1, yhat, 1-yhat)
#   -sum(log(prob))
# }
# 
# optim(c(1.2, -.1), loglik)
```
...
# Mazda RX4
pdf_norm1 = dnorm(qt_norm, mean=yhat[1], sd=sighat) # pdf
...
# Hornet 4 Drive 
pdf_norm2 = dnorm(qt_norm, mean=yhat[4], sd=sighat) # pdf
...
# Hornet Sportabout 
pdf_norm3 = dnorm(qt_norm, mean=yhat[5], sd=sighat) # pdf
