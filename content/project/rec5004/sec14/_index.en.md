...
# icon: book
# icon_pack: fas
linktitle: "Panel Setup"
summary: "Panel data setup notes in R using PNAD microdata, including long versus wide formats, balanced panels, identifiers, joins, and reshaping workflows."
title: "Building Panel Data in R"
weight: 14
output: md_document
type: book
---
...
- As an example, we will use PNAD Continua, which is released quarterly and can be handled with the `PNADcIBGE` package.
...
- Researchers at Ipea ([Teixeira Junior et al., 2020](http://repositorio.ipea.gov.br/bitstream/11058/9951/1/bmt_67_nt_pesos_longitudinais.pdf)) add a few time-invariant key variables to make this identifier more robust:
    - _V2007_: Sex
...
```
## # A tibble: 6 Ãƒâ€” 12
##   Trimestre UPA     DOMIC PAINEL ORDEM SEXO  DIA_NÃ¢â‚¬Â¦Ã‚Â¹ MES_NÃ¢â‚¬Â¦Ã‚Â² ANO_NÃ¢â‚¬Â¦Ã‚Â³ UF    IDADE
##   <chr>     <chr>   <chr> <chr>  <chr> <chr> <chr>   <chr>   <chr>   <chr> <dbl>
## 1 1         110000Ã¢â‚¬Â¦ 01    08     01    2     16      05      1981    11       39
## 2 1         110000Ã¢â‚¬Â¦ 01    08     02    2     12      06      2000    11       20
## 3 1         110000Ã¢â‚¬Â¦ 01    08     03    2     15      05      2004    11       16
## 4 1         110000Ã¢â‚¬Â¦ 01    08     04    1     26      07      1947    11       73
## 5 1         110000Ã¢â‚¬Â¦ 01    08     05    2     15      08      1961    11       59
## 6 1         110000Ã¢â‚¬Â¦ 02    08     01    2     11      07      1983    11       37
## # Ã¢â‚¬Â¦ with 1 more variable: RENDA <dbl>, and abbreviated variable names
## #   Ã‚Â¹Ã¢â‚¬â€¹DIA_NASC, Ã‚Â²Ã¢â‚¬â€¹MES_NASC, Ã‚Â³Ã¢â‚¬â€¹ANO_NASC
```
...
```
## # A tibble: 10 Ãƒâ€” 13
##    ID       TrimeÃ¢â‚¬Â¦Ã‚Â¹ UPA   DOMIC PAINEL ORDEM SEXO  DIA_NÃ¢â‚¬Â¦Ã‚Â² MES_NÃ¢â‚¬Â¦Ã‚Â³ ANO_NÃ¢â‚¬Â¦Ã¢ÂÂ´ UF   
##    <chr>    <chr>   <chr> <chr> <chr>  <chr> <chr> <chr>   <chr>   <chr>   <chr>
##  1 1100000Ã¢â‚¬Â¦ 1       1100Ã¢â‚¬Â¦ 01    08     01    2     16      05      1981    11   
##  2 1100000Ã¢â‚¬Â¦ 1       1100Ã¢â‚¬Â¦ 01    08     02    2     12      06      2000    11   
##  3 1100000Ã¢â‚¬Â¦ 1       1100Ã¢â‚¬Â¦ 01    08     03    2     15      05      2004    11   
##  4 1100000Ã¢â‚¬Â¦ 1       1100Ã¢â‚¬Â¦ 01    08     04    1     26      07      1947    11   
##  5 1100000Ã¢â‚¬Â¦ 1       1100Ã¢â‚¬Â¦ 01    08     05    2     15      08      1961    11   
##  6 1100000Ã¢â‚¬Â¦ 1       1100Ã¢â‚¬Â¦ 02    08     01    2     11      07      1983    11   
##  7 1100000Ã¢â‚¬Â¦ 2       1100Ã¢â‚¬Â¦ 02    08     01    2     11      07      1983    11   
##  8 1100000Ã¢â‚¬Â¦ 1       1100Ã¢â‚¬Â¦ 02    08     02    1     99      99      9999    11   
##  9 1100000Ã¢â‚¬Â¦ 2       1100Ã¢â‚¬Â¦ 02    08     02    1     99      99      9999    11   
## 10 1100000Ã¢â‚¬Â¦ 1       1100Ã¢â‚¬Â¦ 03    08     01    2     09      03      1976    11   
## # Ã¢â‚¬Â¦ with 2 more variables: IDADE <dbl>, RENDA <dbl>, and abbreviated variable
## #   names Ã‚Â¹Ã¢â‚¬â€¹Trimestre, Ã‚Â²Ã¢â‚¬â€¹DIA_NASC, Ã‚Â³Ã¢â‚¬â€¹MES_NASC, Ã¢ÂÂ´Ã¢â‚¬â€¹ANO_NASC
```
...
##   ID        TrimeÃ¢â‚¬Â¦Ã‚Â¹ UPA   DOMIC PAINEL ORDEM SEXO  DIA_NÃ¢â‚¬Â¦Ã‚Â² MES_NÃ¢â‚¬Â¦Ã‚Â³ ANO_NÃ¢â‚¬Â¦Ã¢ÂÂ´ UF   
##   <chr>     <chr>   <chr> <chr> <chr>  <chr> <chr> <chr>   <chr>   <chr>   <chr>
## 1 11000001Ã¢â‚¬Â¦ 1       1100Ã¢â‚¬Â¦ 02    08     01    2     11      07      1983    11   
## 2 11000001Ã¢â‚¬Â¦ 2       1100Ã¢â‚¬Â¦ 02    08     01    2     11      07      1983    11   
## 3 11000001Ã¢â‚¬Â¦ 1       1100Ã¢â‚¬Â¦ 02    08     02    1     99      99      9999    11   
## 4 11000001Ã¢â‚¬Â¦ 2       1100Ã¢â‚¬Â¦ 02    08     02    1     99      99      9999    11   
## 5 11000001Ã¢â‚¬Â¦ 1       1100Ã¢â‚¬Â¦ 03    08     01    2     09      03      1976    11   
## 6 11000001Ã¢â‚¬Â¦ 2       1100Ã¢â‚¬Â¦ 03    08     01    2     09      03      1976    11   
## # Ã¢â‚¬Â¦ with 2 more variables: IDADE <dbl>, RENDA <dbl>, and abbreviated variable
## #   names Ã‚Â¹Ã¢â‚¬â€¹Trimestre, Ã‚Â²Ã¢â‚¬â€¹DIA_NASC, Ã‚Â³Ã¢â‚¬â€¹MES_NASC, Ã¢ÂÂ´Ã¢â‚¬â€¹ANO_NASC
```
...
```
## # A tibble: 6 Ãƒâ€” 11
##   UPA       DOMIC PAINEL ORDEM SEXO  DIA_NÃ¢â‚¬Â¦Ã‚Â¹ MES_NÃ¢â‚¬Â¦Ã‚Â² ANO_NÃ¢â‚¬Â¦Ã‚Â³ UF    VAR_TRI VALUE
##   <chr>     <chr> <chr>  <chr> <chr> <chr>   <chr>   <chr>   <chr> <chr>   <dbl>
...
## # Ã¢â‚¬Â¦ with abbreviated variable names Ã‚Â¹Ã¢â‚¬â€¹DIA_NASC, Ã‚Â²Ã¢â‚¬â€¹MES_NASC, Ã‚Â³Ã¢â‚¬â€¹ANO_NASC
```
...
```
## # A tibble: 6 Ãƒâ€” 12
##   UPA   DOMIC PAINEL ORDEM SEXO  DIA_NÃ¢â‚¬Â¦Ã‚Â¹ MES_NÃ¢â‚¬Â¦Ã‚Â² ANO_NÃ¢â‚¬Â¦Ã‚Â³ UF    VAR   TRI   VALUE
##   <chr> <chr> <chr>  <chr> <chr> <chr>   <chr>   <chr>   <chr> <chr> <chr> <dbl>
## 1 1100Ã¢â‚¬Â¦ 02    08     01    2     11      07      1983    11    IDADE 1        37
## 2 1100Ã¢â‚¬Â¦ 02    08     01    2     11      07      1983    11    RENDA 1        NA
## 3 1100Ã¢â‚¬Â¦ 02    08     01    2     11      07      1983    11    IDADE 2        37
## 4 1100Ã¢â‚¬Â¦ 02    08     01    2     11      07      1983    11    RENDA 2        NA
## 5 1100Ã¢â‚¬Â¦ 02    08     02    1     99      99      9999    11    IDADE 1        31
## 6 1100Ã¢â‚¬Â¦ 02    08     02    1     99      99      9999    11    RENDA 1        NA
## # Ã¢â‚¬Â¦ with abbreviated variable names Ã‚Â¹Ã¢â‚¬â€¹DIA_NASC, Ã‚Â²Ã¢â‚¬â€¹MES_NASC, Ã‚Â³Ã¢â‚¬â€¹ANO_NASC
```
...
```
## # A tibble: 20 Ãƒâ€” 12
##    TRI   UPA       DOMIC PAINEL ORDEM SEXO  DIA_NASC MES_NÃ¢â‚¬Â¦Ã‚Â¹ ANO_NÃ¢â‚¬Â¦Ã‚Â² UF    IDADE
##    <chr> <chr>     <chr> <chr>  <chr> <chr> <chr>    <chr>   <chr>   <chr> <dbl>
...
## # Ã¢â‚¬Â¦ with 1 more variable: RENDA <dbl>, and abbreviated variable names
## #   Ã‚Â¹Ã¢â‚¬â€¹MES_NASC, Ã‚Â²Ã¢â‚¬â€¹ANO_NASC
```
...
```
## # A tibble: 6 Ãƒâ€” 13
##   Trimestre UPA     DOMIC PAINEL ORDEM DIA_NÃ¢â‚¬Â¦Ã‚Â¹ MES_NÃ¢â‚¬Â¦Ã‚Â² ANO_NÃ¢â‚¬Â¦Ã‚Â³ UF    IDADE RENDA
##   <chr>     <chr>   <chr> <chr>  <chr> <chr>   <chr>   <chr>   <chr> <dbl> <dbl>
## 1 1         110000Ã¢â‚¬Â¦ 01    08     01    16      05      1981    11       39  1045
## 2 1         110000Ã¢â‚¬Â¦ 01    08     02    12      06      2000    11       20  1045
## 3 1         110000Ã¢â‚¬Â¦ 01    08     03    15      05      2004    11       16    NA
## 4 1         110000Ã¢â‚¬Â¦ 01    08     04    26      07      1947    11       73    NA
## 5 1         110000Ã¢â‚¬Â¦ 01    08     05    15      08      1961    11       59    NA
## 6 1         110000Ã¢â‚¬Â¦ 02    08     01    11      07      1983    11       37    NA
## # Ã¢â‚¬Â¦ with 2 more variables: `2` <dbl>, `1` <dbl>, and abbreviated variable names
## #   Ã‚Â¹Ã¢â‚¬â€¹DIA_NASC, Ã‚Â²Ã¢â‚¬â€¹MES_NASC, Ã‚Â³Ã¢â‚¬â€¹ANO_NASC
```
...
```
## # A tibble: 6 Ãƒâ€” 23
##   individÃ¢â‚¬Â¦Ã‚Â¹ income  size choicÃ¢â‚¬Â¦Ã‚Â² choicÃ¢â‚¬Â¦Ã‚Â³ choicÃ¢â‚¬Â¦Ã¢ÂÂ´ choicÃ¢â‚¬Â¦Ã¢ÂÂµ wait_Ã¢â‚¬Â¦Ã¢ÂÂ¶ wait_Ã¢â‚¬Â¦Ã¢ÂÂ· wait_Ã¢â‚¬Â¦Ã¢ÂÂ¸
...
## # Ã¢â‚¬Â¦ with 13 more variables: wait_car <int>, vcost_air <int>, vcost_train <int>,
...
## #   Ã‚Â¹Ã¢â‚¬â€¹individual, Ã‚Â²Ã¢â‚¬â€¹choice_air, Ã‚Â³Ã¢â‚¬â€¹choice_train, Ã¢ÂÂ´Ã¢â‚¬â€¹choice_bus, Ã¢ÂÂµÃ¢â‚¬â€¹choice_car,
## #   Ã¢ÂÂ¶Ã¢â‚¬â€¹wait_air, Ã¢ÂÂ·Ã¢â‚¬â€¹wait_train, Ã¢ÂÂ¸Ã¢â‚¬â€¹wait_bus
```
...
```
## # A tibble: 10 Ãƒâ€” 18
##    individual choice wait_air wait_train wait_Ã¢â‚¬Â¦Ã‚Â¹ wait_Ã¢â‚¬Â¦Ã‚Â² vcostÃ¢â‚¬Â¦Ã‚Â³ vcostÃ¢â‚¬Â¦Ã¢ÂÂ´ vcostÃ¢â‚¬Â¦Ã¢ÂÂµ
...
## # Ã¢â‚¬Â¦ with 9 more variables: vcost_car <int>, travel_air <int>,
## #   travel_train <int>, travel_bus <int>, travel_car <int>, gcost_air <int>,
## #   gcost_train <int>, gcost_bus <int>, gcost_car <int>, and abbreviated
## #   variable names Ã‚Â¹Ã¢â‚¬â€¹wait_bus, Ã‚Â²Ã¢â‚¬â€¹wait_car, Ã‚Â³Ã¢â‚¬â€¹vcost_air, Ã¢ÂÂ´Ã¢â‚¬â€¹vcost_train, Ã¢ÂÂµÃ¢â‚¬â€¹vcost_bus
```
