...
summary: "Probability distribution and simulation notes in R for econometrics, including normal, t, chi-squared, and related sampling concepts."
...
x: either a vector of one or more elements from which to choose, or a positive integer. See Ã¢â‚¬ËœDetails.Ã¢â‚¬â„¢
